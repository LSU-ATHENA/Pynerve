...
__global__ void
zigzagForwardKernel(const int *__restrict__ boundary_matrix, const int *__restrict__ simplex_dims,
                    int num_simplices, const ZigzagStep *__restrict__ steps, int num_steps,
                    ...
                    int *__restrict__ persistence_dim, int *__restrict__ pair_count, int max_pairs)
{
    ...
    if (step.type == ZigzagStep::FORWARD_INCLUSION || step.type == ZigzagStep::BACKWARD_INCLUSION)
    {
 ...
 */
__global__ void dynamicUpdateKernel(int *__restrict__ complex_simplices,
                                    int *__restrict__ complex_size, int max_complex_size,
                                    const int *__restrict__ new_simplices, int num_new,
