...
double estimateProblemOps(size_t n_points, size_t point_dim, int max_dim);
} // namespace detail
namespace factory
{
...
namespace utils
{
size_t estimateMemoryRequirements(size_t n_points, size_t point_dim, int max_dim,
                                  const VRConfig &config);
bool isAccelerationBeneficial(size_t n_points, int max_dim, double max_radius);
} // namespace utils
} // namespace nerve::persistence::accelerated
