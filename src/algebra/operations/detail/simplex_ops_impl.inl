...
std::vector<Simplex> faces_with_vertex_count(const std::vector<Index> &vertices, Size vertex_count)
{
...
Simplex::Simplex(const std::vector<Index> &vertices)
    : vertices_(vertices)
{
    canonicalize();
}
...
std::vector<Simplex> Simplex::cofaces(const std::vector<Simplex> &complex,
                                      const core::DeterminismContract &contract) const
{
    ...
    const auto impl =
        static_cast<std::vector<Simplex> (Simplex::*)(const std::vector<Simplex> &) const>(
            &Simplex::cofaces);
...
std::vector<Simplex> Simplex::kFaces(Size k, const core::DeterminismContract &contract) const
{
    ...
    const auto impl = static_cast<std::vector<Simplex> (Simplex::*)(Size) const>(&Simplex::kFaces);
    return (this->*impl)(k);
}
...
Simplex Simplex::faceWithoutVertex(Index vertex, const core::DeterminismContract &contract) const
{
    ...
    const auto impl = static_cast<Simplex (Simplex::*)(Index) const>(&Simplex::faceWithoutVertex);
    return (this->*impl)(vertex);
}
std::vector<Simplex> Simplex::facesWithoutVertices(const std::vector<Index> &vertices) const
{
    std::vector<Simplex> result;
    const auto face_impl =
        static_cast<Simplex (Simplex::*)(Index) const>(&Simplex::faceWithoutVertex);
...
std::vector<Simplex> Simplex::facesWithoutVertices(const std::vector<Index> &vertices,
                                                   const core::DeterminismContract &contract) const
{
    if (strictContractUnsatisfied(contract))
    {
    ...
    const auto impl =
        static_cast<std::vector<Simplex> (Simplex::*)(const std::vector<Index> &) const>(
            &Simplex::facesWithoutVertices);
...
std::vector<Simplex> Simplex::potentialCofaces(const std::vector<Index> &available_vertices,
                                               const core::DeterminismContract &contract) const
{
    if (strictContractUnsatisfied(contract))
    {
...
std::vector<Simplex> Simplex::kCofaces(Size k, const std::vector<Simplex> &complex,
                                       const core::DeterminismContract &contract) const
{
    if (strictContractUnsatisfied(contract))
    {
    ...
    const auto impl =
        static_cast<std::vector<Simplex> (Simplex::*)(Size, const std::vector<Simplex> &) const>(
            &Simplex::kCofaces);
...
Simplex Simplex::star(const std::vector<Simplex> &complex) const
{
    ...
    if (!star_simplices.empty())
    {
        auto max_it = std::max_element(
            star_simplices.begin(), star_simplices.end(),
            [](const Simplex &a, const Simplex &b) { return a.dimension() < b.dimension(); });
        return *max_it;
    }
    return Simplex();
}
                      ...
                      const core::DeterminismContract &contract) const
{
    ...
    const auto impl =
        static_cast<Simplex (Simplex::*)(const std::vector<Simplex> &) const>(&Simplex::star);
    return (this->*impl)(complex);
}
Simplex Simplex::link(const std::vector<Simplex> &complex) const
{
    const auto star_impl =
        static_cast<Simplex (Simplex::*)(const std::vector<Simplex> &) const>(&Simplex::star);
    const auto faces_impl = static_cast<std::vector<Simplex> (Simplex::*)() const>(&Simplex::faces);
    const auto meet_impl = static_cast<Simplex (Simplex::*)(const Simplex &) const>(&Simplex::meet);
                      ...
                      const core::DeterminismContract &contract) const
{
    ...
    const auto impl =
        static_cast<Simplex (Simplex::*)(const std::vector<Simplex> &) const>(&Simplex::link);
    return (this->*impl)(complex);
}
