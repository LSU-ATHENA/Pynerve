bool canFormH1Feature(const Edge &edge, const std::vector<Point> &points, double max_radius,
...
std::vector<Edge> pruneByLocalConnectivity(const std::vector<Edge> &edges,
...
std::vector<Triangle> filterTriangles(const std::vector<Triangle> &triangles,
