...
std::vector<Pair> computeVrPersistenceAuto(const core::BufferView<const double> &points,
...
std::vector<Pair> computeVrPersistenceWithAlgorithm(const core::BufferView<const double> &points,
...
std::vector<AlgorithmBenchmark> benchmarkAllAlgorithms(const core::BufferView<const double> &points,
                                                       Size point_dim, const VRConfig &config)
{
