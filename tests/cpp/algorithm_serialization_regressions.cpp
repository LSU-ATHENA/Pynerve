...
int main()
{
...

    {
        ...
        const char *corrupt_path = "nerve_perfect_hash_corrupt.bin";
        {
            ...
            assert(std::fwrite(&impossible_vector_size, sizeof(impossible_vector_size), 1, file) ==
                   1);
            std::fclose(file);
        }
...

    {
        ...
        try
        {
            nerve::persistence::bloom::BloomFilter bloom(128,
...

    {
        ...
        {
            found_finite_pair =
                found_finite_pair || (pair.birth_index == 1 && pair.death_index == 2 &&
