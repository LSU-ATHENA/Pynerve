...
class TestCurriculumTrainerDeep:
    ...
    def test_create_dataloader_invalid_batch(self):
        ...
        with pytest.raises(ValueError, match="positive"):
            trainer.create_dataloader(dataset, [make_diag_3d(3) for _ in range(10)], batch_size=0)
    ...
    def test_create_dataloader_invalid_workers(self):
        ...
        with pytest.raises(ValueError, match="non-negative"):
            trainer.create_dataloader(dataset, [make_diag_3d(3) for _ in range(10)], num_workers=-1)
    ...
    def test_fit_negative_epochs(self):
        ...
        trainer = TopologicalCurriculumTrainer(model, CurriculumConfig())
        with pytest.raises(ValueError, match="non-negative"):
            trainer.fit(list(range(5)), [make_diag_3d(3) for _ in range(5)], epochs=-1)
...
class TestDiffLossDeep:
    ...
    def test_multi_scale_loss_forward(self):
        ...
        d = make_diag_3d(6)
        targets = [make_diag_3d(3), make_diag_3d(4)]
    ...
    def test_multi_scale_loss_wrong_targets(self):
        ...
        with pytest.raises(ValueError, match="length"):
            obj.forward(d, [make_diag_3d(3)])  # wrong number of targets
