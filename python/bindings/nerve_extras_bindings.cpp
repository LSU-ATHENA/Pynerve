...
py::array_t<double> npy_array_to_numpy(const nerve::io::NpyArray &arr)
{
    if (arr.header.dtype != nerve::io::NpyDataType::Float64)
    {
        throw std::runtime_error(
            "Only Float64 NPY arrays can be converted to numpy arrays; "
...
nerve::io::NpyArray numpy_to_npy_array(py::array_t<double, py::array::c_style | py::array::forcecast> arr)
{
...
PYBIND11_MODULE(nerve_extras, m)
{
    ...
    // io/npy_io -- NPY file format I/O
    {
        ...
        py::class_<nerve::io::NpyArray>(npy, "NpyArray")
            ...
            .def_property_readonly("data", [](const nerve::io::NpyArray &a) {
                return py::bytes(reinterpret_cast<const char *>(a.data.data()), a.data.size());
            })
            .def("to_numpy", &npy_array_to_numpy,
                 "Convert a Float64 NPY array to a numpy ndarray")
        ...
        npy.def("load_npy_to_numpy",
                [](const std::string &path) { return npy_array_to_numpy(nerve::io::loadNpy(path)); },
                py::arg("path"),
                "Load a .npy file and convert to a numpy ndarray (Float64 only)");
        npy.def("save_numpy_to_npy",
                [](const std::string &path,
                   py::array_t<double, py::array::c_style | py::array::forcecast> arr) {
                    nerve::io::saveNpy(path, numpy_to_npy_array(arr));
                },
                py::arg("path"), py::arg("array"),
    ...
    {
        auto thr = m.def_submodule("threading",
                                    "CPU topology detection and thread-pinning utilities");
        ...
        py::class_<nerve::core::CpuTopology>(thr, "CpuTopology")
            ...
            .def("same_core_as", &nerve::core::CpuTopology::sameCoreAs,
                 py::arg("a"), py::arg("b"),
                 "Return True if two logical CPUs share a physical core")
            .def("same_numa_as", &nerve::core::CpuTopology::sameNumaAs,
                 py::arg("a"), py::arg("b"),
        ...
        thr.def("pin_current_thread_to_package", &nerve::core::pinCurrentThreadToPackage,
                py::arg("package_id"),
                "Pin the calling thread to a specific CPU package/socket");
        thr.def("pin_current_thread_to_numa_node", &nerve::core::pinCurrentThreadToNumaNode,
                py::arg("numa_node"),
                "Pin the calling thread to a specific NUMA node");
    ...
    {
        auto simd = m.def_submodule("simd_nn",
                                     "SIMD-accelerated neural network primitives");
        ...
        simd.def("relu",
                 ...
                 py::arg("data"),
                 "Apply ReLU in-place to a numpy array of doubles, return the array");
        ...
        simd.def("tanh",
                 ...
                 py::arg("data"),
                 "Apply tanh in-place to a numpy array of doubles, return the array");

        simd.def("batch_norm",
                 [](py::array_t<double, py::array::c_style | py::array::forcecast> data,
                    double mean, double std_inv) {
                     py::buffer_info info = data.request();
    ...
    {
        auto batch = m.def_submodule("batching",
                                      "Micro-batch processing utilities");
        ...
        py::class_<nerve::batching::MicroBatchProcessor>(batch, "MicroBatchProcessor")
            .def(py::init<nerve::Size, nerve::Size>(),
                 py::arg("batch_size") = 32, py::arg("max_pending") = 128)
    ...
    // cache/feature_cache -- feature caching with LRU eviction
    {
        ...
        py::class_<nerve::cache::FeatureCache::FeatureEntry>(cache, "FeatureEntry")
            ...
            .def_readonly("access_count",
                          &nerve::cache::FeatureCache::FeatureEntry::access_count)
        ...
        py::class_<nerve::cache::FeatureCache::CacheStats>(cache, "CacheStats")
            ...
            .def_readonly("total_entries",
                          &nerve::cache::FeatureCache::CacheStats::total_entries)
        ...
        py::class_<nerve::cache::FeatureCache>(cache, "FeatureCache")
            ...
            .def("put_feature", &nerve::cache::FeatureCache::putFeature,
                 py::arg("symbol_id"), py::arg("timestamp_ns"), py::arg("features"),
                 "Store a feature vector for a symbol at a timestamp")
            .def("get_feature", [](nerve::cache::FeatureCache &self,
                                     int64_t symbol_id, int64_t timestamp_ns) {
            ...
            .def("get_latest_feature", [](nerve::cache::FeatureCache &self,
                                            int64_t symbol_id) {
                std::vector<float> features;
            ...
            .def("get_features_batch",
                 ...
                 py::arg("symbol_ids"), py::arg("timestamps"),
            ...
            .def("clear_all", &nerve::cache::FeatureCache::clearAll,
                 "Clear all cached entries")
            .def("get_stats", &nerve::cache::FeatureCache::getStats,
                 "Get cache statistics")
            .def("reset_stats", &nerve::cache::FeatureCache::resetStats,
        ...
        py::class_<nerve::cache::RingBuffer>(cache, "RingBuffer")
            ...
            .def("size", &nerve::cache::RingBuffer::size,
                 "Current number of entries")
            .def("capacity", &nerve::cache::RingBuffer::capacity,
                 "Maximum capacity")
            .def("empty", &nerve::cache::RingBuffer::empty,
                 "Check if empty")
            .def("full", &nerve::cache::RingBuffer::full,
                 "Check if full")
            .def("clear", &nerve::cache::RingBuffer::clear,
                 "Clear all entries");
        ...
        py::class_<nerve::cache::CacheManager>(cache, "CacheManager")
            ...
            .def("register_cache", &nerve::cache::CacheManager::registerCache,
                 py::arg("name"), py::arg("cache"),
    ...
    // filtration/simd_filtration -- SIMD-accelerated filtration ops
    {
        ...
        filt.def("sort_pairs_by_birth",
                 [](py::array_t<double, py::array::c_style | py::array::forcecast> pairs) {
                     ...
                     nerve::filtration::simdSortPairsByBirth(vec.data(),
                                                             static_cast<nerve::Size>(n));
                     for (size_t i = 0; i < n; ++i)
                     {
    ...
    {
        auto anomaly = m.def_submodule("anomaly",
                                        "Topological anomaly and drift detection");
        ...
        py::class_<nerve::anomaly::PersistenceProfile>(anomaly, "PersistenceProfile")
            ...
            .def_readwrite("persistence_mean", &nerve::anomaly::PersistenceProfile::persistence_mean)
            ...
            .def_readwrite("persistence_variance", &nerve::anomaly::PersistenceProfile::persistence_variance)
            ...
            .def_readwrite("persistence_histogram", &nerve::anomaly::PersistenceProfile::persistence_histogram);

        // BettiChangeDetector
        py::class_<nerve::anomaly::BettiChangeDetector::ChangeConfig>(anomaly, "ChangeConfig")
            .def(py::init<>())
            .def_readwrite("significance_level", &nerve::anomaly::BettiChangeDetector::ChangeConfig::significance_level)
            .def_readwrite("min_window_size", &nerve::anomaly::BettiChangeDetector::ChangeConfig::min_window_size)
            .def_readwrite("max_window_size", &nerve::anomaly::BettiChangeDetector::ChangeConfig::max_window_size)
            .def_readwrite("enable_trend_detection", &nerve::anomaly::BettiChangeDetector::ChangeConfig::enable_trend_detection)
            .def_readwrite("min_change_threshold", &nerve::anomaly::BettiChangeDetector::ChangeConfig::min_change_threshold);

        py::class_<nerve::anomaly::BettiChangeDetector::ChangePoint>(anomaly, "ChangePoint")
            .def(py::init<>())
            .def_readwrite("timestamp_ns", &nerve::anomaly::BettiChangeDetector::ChangePoint::timestamp_ns)
            .def_readwrite("window_index", &nerve::anomaly::BettiChangeDetector::ChangePoint::window_index)
            .def_readwrite("betti_before", &nerve::anomaly::BettiChangeDetector::ChangePoint::betti_before)
            .def_readwrite("betti_after", &nerve::anomaly::BettiChangeDetector::ChangePoint::betti_after)
            .def_readwrite("change_magnitude", &nerve::anomaly::BettiChangeDetector::ChangePoint::change_magnitude)
            .def_readwrite("p_value", &nerve::anomaly::BettiChangeDetector::ChangePoint::p_value)
            .def_readwrite("change_type", &nerve::anomaly::BettiChangeDetector::ChangePoint::change_type);

        py::class_<nerve::anomaly::BettiChangeDetector::TrendInfo>(anomaly, "TrendInfo")
            .def(py::init<>())
            .def_readwrite("is_trending", &nerve::anomaly::BettiChangeDetector::TrendInfo::is_trending)
            .def_readwrite("trend_slope", &nerve::anomaly::BettiChangeDetector::TrendInfo::trend_slope)
            .def_readwrite("trend_strength", &nerve::anomaly::BettiChangeDetector::TrendInfo::trend_strength)
            .def_readwrite("trend_direction", &nerve::anomaly::BettiChangeDetector::TrendInfo::trend_direction);

        py::class_<nerve::anomaly::BettiChangeDetector>(anomaly, "BettiChangeDetector")
            .def(py::init<const nerve::anomaly::BettiChangeDetector::ChangeConfig &>(), py::arg("config"))
            ...
            .def("update_and_detect", [](nerve::anomaly::BettiChangeDetector &self,
                                           const std::vector<double> &new_betti,
            ...
            .def("compute_statistical_distance", &nerve::anomaly::BettiChangeDetector::computeStatisticalDistance,
                 py::arg("seq1"), py::arg("seq2"),
                 "Compute statistical distance between two sequences")
            .def("compute_p_value", &nerve::anomaly::BettiChangeDetector::computePValue,
                 py::arg("seq1"), py::arg("seq2"),
                 "Compute p-value for two sequences")
            .def("analyze_trend", &nerve::anomaly::BettiChangeDetector::analyzeTrend,
                 py::arg("betti_sequence"),
                 "Analyze trend in a Betti sequence, returns TrendInfo");

        // LifetimeDriftDetector
        py::class_<nerve::anomaly::LifetimeDriftDetector::DriftConfig>(anomaly, "DriftConfig")
            .def(py::init<>())
            .def_readwrite("drift_threshold", &nerve::anomaly::LifetimeDriftDetector::DriftConfig::drift_threshold)
            .def_readwrite("reference_window_size", &nerve::anomaly::LifetimeDriftDetector::DriftConfig::reference_window_size)
            .def_readwrite("detection_window_size", &nerve::anomaly::LifetimeDriftDetector::DriftConfig::detection_window_size)
            .def_readwrite("enable_adaptive_threshold", &nerve::anomaly::LifetimeDriftDetector::DriftConfig::enable_adaptive_threshold)
            .def_readwrite("distance_metric", &nerve::anomaly::LifetimeDriftDetector::DriftConfig::distance_metric)
            .def_readwrite("wasserstein_order", &nerve::anomaly::LifetimeDriftDetector::DriftConfig::wasserstein_order);

        py::class_<nerve::anomaly::LifetimeDriftDetector::DriftPoint>(anomaly, "DriftPoint")
            .def(py::init<>())
            .def_readwrite("timestamp_ns", &nerve::anomaly::LifetimeDriftDetector::DriftPoint::timestamp_ns)
            .def_readwrite("drift_score", &nerve::anomaly::LifetimeDriftDetector::DriftPoint::drift_score)
            .def_readwrite("p_value", &nerve::anomaly::LifetimeDriftDetector::DriftPoint::p_value)
            .def_readwrite("reference_lifetimes", &nerve::anomaly::LifetimeDriftDetector::DriftPoint::reference_lifetimes)
            .def_readwrite("current_lifetimes", &nerve::anomaly::LifetimeDriftDetector::DriftPoint::current_lifetimes)
            .def_readwrite("distance_value", &nerve::anomaly::LifetimeDriftDetector::DriftPoint::distance_value)
            .def_readwrite("is_drift_detected", &nerve::anomaly::LifetimeDriftDetector::DriftPoint::is_drift_detected);

        py::class_<nerve::anomaly::LifetimeDriftDetector>(anomaly, "LifetimeDriftDetector")
            .def(py::init<const nerve::anomaly::LifetimeDriftDetector::DriftConfig &>(), py::arg("config"))
            ...
            .def("detect_single_drift", &nerve::anomaly::LifetimeDriftDetector::detectSingleDrift,
                 py::arg("reference_lifetimes"), py::arg("current_lifetimes"), py::arg("timestamp_ns"),
                 "Detect a single drift event between two lifetime distributions")
            .def("update_and_detect", [](nerve::anomaly::LifetimeDriftDetector &self,
                                           const std::vector<float> &new_lifetimes,
                                           int64_t timestamp_ns) {
            ...
            .def("compute_sliced_wasserstein_distance", &nerve::anomaly::LifetimeDriftDetector::computeSlicedWassersteinDistance,
            ...
            .def("compute_kl_divergence", &nerve::anomaly::LifetimeDriftDetector::computeKlDivergence,
                 py::arg("dist1"), py::arg("dist2"),
                 "Compute KL divergence between two distributions")
            .def("update_reference_distribution", &nerve::anomaly::LifetimeDriftDetector::updateReferenceDistribution,
                 py::arg("new_reference"),
        ...
        py::class_<nerve::anomaly::MarketAnomalyDetector::MarketConfig>(anomaly, "MarketConfig")
            .def(py::init<>())
            .def_readwrite("price_change_threshold", &nerve::anomaly::MarketAnomalyDetector::MarketConfig::price_change_threshold)
            .def_readwrite("volume_spike_threshold", &nerve::anomaly::MarketAnomalyDetector::MarketConfig::volume_spike_threshold)
            .def_readwrite("topology_anomaly_threshold", &nerve::anomaly::MarketAnomalyDetector::MarketConfig::topology_anomaly_threshold)
            .def_readwrite("lookback_window", &nerve::anomaly::MarketAnomalyDetector::MarketConfig::lookback_window)
            .def_readwrite("enable_volume_analysis", &nerve::anomaly::MarketAnomalyDetector::MarketConfig::enable_volume_analysis)
            .def_readwrite("enable_price_analysis", &nerve::anomaly::MarketAnomalyDetector::MarketConfig::enable_price_analysis)
            .def_readwrite("enable_topology_analysis", &nerve::anomaly::MarketAnomalyDetector::MarketConfig::enable_topology_analysis);

        py::class_<nerve::anomaly::MarketAnomalyDetector::AnomalyEvent>(anomaly, "AnomalyEvent")
            .def(py::init<>())
            .def_readwrite("timestamp_ns", &nerve::anomaly::MarketAnomalyDetector::AnomalyEvent::timestamp_ns)
            .def_readwrite("anomaly_type", &nerve::anomaly::MarketAnomalyDetector::AnomalyEvent::anomaly_type)
            .def_readwrite("anomaly_score", &nerve::anomaly::MarketAnomalyDetector::AnomalyEvent::anomaly_score)
            .def_readwrite("p_value", &nerve::anomaly::MarketAnomalyDetector::AnomalyEvent::p_value)
            .def_readwrite("description", &nerve::anomaly::MarketAnomalyDetector::AnomalyEvent::description)
            .def_readwrite("contributing_factors", &nerve::anomaly::MarketAnomalyDetector::AnomalyEvent::contributing_factors)
            .def_readwrite("is_critical", &nerve::anomaly::MarketAnomalyDetector::AnomalyEvent::is_critical);

        py::class_<nerve::anomaly::MarketAnomalyDetector>(anomaly, "MarketAnomalyDetector")
            .def(py::init<const nerve::anomaly::MarketAnomalyDetector::MarketConfig &>(), py::arg("config"))
            .def("detect_anomalies", &nerve::anomaly::MarketAnomalyDetector::detectAnomalies,
                 py::arg("timestamps"), py::arg("prices"), py::arg("volumes"), py::arg("topological_features"),
                 "Detect anomalies across market data sequences")
            .def("detect_single_anomaly", &nerve::anomaly::MarketAnomalyDetector::detectSingleAnomaly,
                 py::arg("timestamp_ns"), py::arg("price"), py::arg("volume"), py::arg("topological_features"),
                 "Detect a single anomaly event")
            .def("update_and_detect", [](nerve::anomaly::MarketAnomalyDetector &self,
                                           int64_t timestamp_ns, double price, float volume,
                                           const std::vector<float> &topological_features) {
                nerve::anomaly::MarketAnomalyDetector::AnomalyEvent ae;
                bool detected = self.updateAndDetect(timestamp_ns, price, volume, topological_features, ae);
            ...
            .def("detect_price_anomaly", &nerve::anomaly::MarketAnomalyDetector::detectPriceAnomaly,
                 py::arg("current_price"), py::arg("price_history"),
                 "Detect a price anomaly")
            .def("detect_volume_anomaly", &nerve::anomaly::MarketAnomalyDetector::detectVolumeAnomaly,
                 py::arg("current_volume"), py::arg("volume_history"),
                 "Detect a volume anomaly")
            .def("detect_topology_anomaly", &nerve::anomaly::MarketAnomalyDetector::detectTopologyAnomaly,
                 py::arg("current_features"), py::arg("feature_history"),
                 "Detect a topological anomaly")
            .def("detect_combined_anomaly", &nerve::anomaly::MarketAnomalyDetector::detectCombinedAnomaly,
                 py::arg("factor_scores"), py::arg("factor_names"),
                 "Detect a combined anomaly from multiple factors")
            .def("update_normal_behavior", &nerve::anomaly::MarketAnomalyDetector::updateNormalBehavior,
                 py::arg("prices"), py::arg("volumes"), py::arg("topological_features"),
                 "Update the baseline normal behavior model")
            .def("reset_normal_behavior", &nerve::anomaly::MarketAnomalyDetector::resetNormalBehavior,
        ...
        py::class_<nerve::anomaly::OnlinePValueCalculator::PValueConfig>(anomaly, "PValueConfig")
            .def(py::init<>())
            .def_readwrite("significance_level", &nerve::anomaly::OnlinePValueCalculator::PValueConfig::significance_level)
            .def_readwrite("min_samples", &nerve::anomaly::OnlinePValueCalculator::PValueConfig::min_samples)
            .def_readwrite("enable_fdr_control", &nerve::anomaly::OnlinePValueCalculator::PValueConfig::enable_fdr_control)
            .def_readwrite("fdr_rate", &nerve::anomaly::OnlinePValueCalculator::PValueConfig::fdr_rate);

        py::class_<nerve::anomaly::OnlinePValueCalculator>(anomaly, "OnlinePValueCalculator")
            .def(py::init<const nerve::anomaly::OnlinePValueCalculator::PValueConfig &>(), py::arg("config"))
            ...
            .def("compute_empirical_p_value", &nerve::anomaly::OnlinePValueCalculator::computeEmpiricalPValue,
                 py::arg("test_statistic"), py::arg("sample_distribution"),
                 "Compute an empirical p-value from a sample distribution")
            .def("bonferroni_correction", &nerve::anomaly::OnlinePValueCalculator::bonferroniCorrection,
                 py::arg("p_values"),
                 "Apply Bonferroni correction to multiple p-values")
            .def("benjamini_hochberg_fdr", &nerve::anomaly::OnlinePValueCalculator::benjaminiHochbergFdr,
                 py::arg("p_values"),
                 "Apply Benjamini-Hochberg FDR correction")
            .def("update_null_distribution", &nerve::anomaly::OnlinePValueCalculator::updateNullDistribution,
                 py::arg("new_sample"),
                 "Update the null distribution with a new sample")
            .def("update_sample_distribution", &nerve::anomaly::OnlinePValueCalculator::updateSampleDistribution,
                 py::arg("new_sample"),
                 "Update the sample distribution with a new sample")
            .def("is_significant", &nerve::anomaly::OnlinePValueCalculator::isSignificant,
                 py::arg("p_value"),
                 "Check if a p-value is significant")
            .def("multiple_testing_significance", &nerve::anomaly::OnlinePValueCalculator::multipleTestingSignificance,
                 py::arg("p_values"),
                 "Test multiple p-values for significance")
            .def("compute_effect_size", &nerve::anomaly::OnlinePValueCalculator::computeEffectSize,
                 py::arg("sample_mean"), py::arg("null_mean"), py::arg("sample_std"), py::arg("null_std"),
                 "Compute effect size between sample and null")
            .def("compute_confidence_interval", &nerve::anomaly::OnlinePValueCalculator::computeConfidenceInterval,
        ...
        py::class_<nerve::anomaly::RegimeChangeDetector::RegimeConfig>(anomaly, "RegimeConfig")
            .def(py::init<>())
            .def_readwrite("regime_change_threshold", &nerve::anomaly::RegimeChangeDetector::RegimeConfig::regime_change_threshold)
            .def_readwrite("min_regime_duration", &nerve::anomaly::RegimeChangeDetector::RegimeConfig::min_regime_duration)
            .def_readwrite("enable_hmm_detection", &nerve::anomaly::RegimeChangeDetector::RegimeConfig::enable_hmm_detection)
            .def_readwrite("num_regimes", &nerve::anomaly::RegimeChangeDetector::RegimeConfig::num_regimes)
            .def_readwrite("transition_probability", &nerve::anomaly::RegimeChangeDetector::RegimeConfig::transition_probability);
        ...
        py::class_<nerve::anomaly::RegimeChangeDetector::Regime>(anomaly, "Regime")
            ...
            .def_readwrite("characteristic_features", &nerve::anomaly::RegimeChangeDetector::Regime::characteristic_features)
            .def_readwrite("stability_score", &nerve::anomaly::RegimeChangeDetector::Regime::stability_score)
            .def_readwrite("start_timestamp_ns", &nerve::anomaly::RegimeChangeDetector::Regime::start_timestamp_ns)
            .def_readwrite("end_timestamp_ns", &nerve::anomaly::RegimeChangeDetector::Regime::end_timestamp_ns)
            .def_readwrite("duration_points", &nerve::anomaly::RegimeChangeDetector::Regime::duration_points)
            .def_readwrite("description", &nerve::anomaly::RegimeChangeDetector::Regime::description);

        py::class_<nerve::anomaly::RegimeChangeDetector::RegimeChange>(anomaly, "RegimeChange")
            .def(py::init<>())
            .def_readwrite("timestamp_ns", &nerve::anomaly::RegimeChangeDetector::RegimeChange::timestamp_ns)
            .def_readwrite("from_regime_id", &nerve::anomaly::RegimeChangeDetector::RegimeChange::from_regime_id)
            .def_readwrite("to_regime_id", &nerve::anomaly::RegimeChangeDetector::RegimeChange::to_regime_id)
            .def_readwrite("change_confidence", &nerve::anomaly::RegimeChangeDetector::RegimeChange::change_confidence)
            .def_readwrite("transition_features", &nerve::anomaly::RegimeChangeDetector::RegimeChange::transition_features)
            .def_readwrite("change_description", &nerve::anomaly::RegimeChangeDetector::RegimeChange::change_description);

        py::class_<nerve::anomaly::RegimeChangeDetector::HMMModel>(anomaly, "HMMModel")
            .def(py::init<>())
            .def_readwrite("emission_means", &nerve::anomaly::RegimeChangeDetector::HMMModel::emission_means)
            .def_readwrite("emission_covariances", &nerve::anomaly::RegimeChangeDetector::HMMModel::emission_covariances)
            .def_readwrite("transition_matrix", &nerve::anomaly::RegimeChangeDetector::HMMModel::transition_matrix)
            .def_readwrite("initial_probabilities", &nerve::anomaly::RegimeChangeDetector::HMMModel::initial_probabilities);

        py::class_<nerve::anomaly::RegimeChangeDetector>(anomaly, "RegimeChangeDetector")
            .def(py::init<const nerve::anomaly::RegimeChangeDetector::RegimeConfig &>(), py::arg("config"))
            ...
            .def("detect_regime_changes", &nerve::anomaly::RegimeChangeDetector::detectRegimeChanges,
                 py::arg("topological_features"), py::arg("timestamps"),
                 "Detect regime change points")
            .def("update_and_detect", [](nerve::anomaly::RegimeChangeDetector &self,
            ...
            .def("extract_regime_features", &nerve::anomaly::RegimeChangeDetector::extractRegimeFeatures,
            ...
            .def("train_hmm", &nerve::anomaly::RegimeChangeDetector::trainHmm,
                 py::arg("features"), py::arg("regime_labels"),
                 "Train a Hidden Markov Model on labeled regime data")
        ...
        py::class_<nerve::anomaly::AnomalyDetectionManager::AnomalyReport>(anomaly, "AnomalyReport")
            .def(py::init<>())
            .def_readwrite("betti_changes", &nerve::anomaly::AnomalyDetectionManager::AnomalyReport::betti_changes)
            .def_readwrite("drift_points", &nerve::anomaly::AnomalyDetectionManager::AnomalyReport::drift_points)
            .def_readwrite("market_anomalies", &nerve::anomaly::AnomalyDetectionManager::AnomalyReport::market_anomalies)
            .def_readwrite("regime_changes", &nerve::anomaly::AnomalyDetectionManager::AnomalyReport::regime_changes)
            .def_readwrite("overall_anomaly_score", &nerve::anomaly::AnomalyDetectionManager::AnomalyReport::overall_anomaly_score)
            .def_readwrite("summary_report", &nerve::anomaly::AnomalyDetectionManager::AnomalyReport::summary_report);
        ...
        py::class_<nerve::anomaly::AnomalyDetectionManager>(anomaly, "AnomalyDetectionManager")
            ...
            .def("set_betti_detector_config", &nerve::anomaly::AnomalyDetectionManager::setBettiDetectorConfig,
                 py::arg("config"),
                 "Set the BettiChangeDetector configuration")
            .def("set_drift_detector_config", &nerve::anomaly::AnomalyDetectionManager::setDriftDetectorConfig,
                 py::arg("config"),
                 "Set the LifetimeDriftDetector configuration")
            .def("set_market_detector_config", &nerve::anomaly::AnomalyDetectionManager::setMarketDetectorConfig,
                 py::arg("config"),
                 "Set the MarketAnomalyDetector configuration")
            .def("set_pvalue_config", &nerve::anomaly::AnomalyDetectionManager::setPvalueConfig,
                 py::arg("config"),
                 "Set the OnlinePValueCalculator configuration")
            .def("set_regime_config", &nerve::anomaly::AnomalyDetectionManager::setRegimeConfig,
                 py::arg("config"),
                 "Set the RegimeChangeDetector configuration")
            ...
            .def("get_pvalue_calculator", &nerve::anomaly::AnomalyDetectionManager::getPvalueCalculator,
            ...
            .def("detect_all_anomalies", &nerve::anomaly::AnomalyDetectionManager::detectAllAnomalies,
                 py::arg("timestamps"), py::arg("prices"), py::arg("volumes"),
                 py::arg("betti_sequences"), py::arg("lifetime_sequences"), py::arg("topological_features"),
            ...
            .def("generate_alerts", &nerve::anomaly::AnomalyDetectionManager::generateAlerts,
                 py::arg("report"),
                 "Generate alert strings from an AnomalyReport")
    ...
    // error/error_handling -- circuit breaker, retry, observability
    {
        auto err = m.def_submodule("error",
                                    "Error handling: circuit breaker, retry, observability");
        ...
        py::class_<nerve::error::CallContract>(err, "CallContract")
            ...
            .def_readwrite("strict_time_enforcement", &nerve::error::CallContract::strict_time_enforcement)
        ...
        py::class_<nerve::error::CircuitBreakerConfig>(err, "CircuitBreakerConfig")
            .def(py::init<>())
            .def_readwrite("max_consecutive_failures", &nerve::error::CircuitBreakerConfig::max_consecutive_failures)
            .def_readwrite("cooldown_ms", &nerve::error::CircuitBreakerConfig::cooldown_ms)
            .def_readwrite("enable_automatic_recovery", &nerve::error::CircuitBreakerConfig::enable_automatic_recovery)
            .def_readwrite("recovery_sample_ratio", &nerve::error::CircuitBreakerConfig::recovery_sample_ratio);
        ...
        py::class_<nerve::error::ErrorEvent>(err, "ErrorEvent")
            ...
            .def("to_json", &nerve::error::ErrorEvent::toJson,
                 "Serialize to JSON")
        ...
        py::class_<nerve::error::CircuitBreaker::CircuitBreakerStats>(err, "CircuitBreakerStats")
            .def(py::init<>())
            .def_readwrite("total_operations", &nerve::error::CircuitBreaker::CircuitBreakerStats::total_operations)
            .def_readwrite("successful_operations", &nerve::error::CircuitBreaker::CircuitBreakerStats::successful_operations)
            .def_readwrite("failed_operations", &nerve::error::CircuitBreaker::CircuitBreakerStats::failed_operations)
            .def_readwrite("consecutive_failures", &nerve::error::CircuitBreaker::CircuitBreakerStats::consecutive_failures)
            .def_readwrite("current_state", &nerve::error::CircuitBreaker::CircuitBreakerStats::current_state)
            .def_readwrite("failing_operations", &nerve::error::CircuitBreaker::CircuitBreakerStats::failing_operations);
        ...
        py::class_<nerve::error::CircuitBreaker>(err, "CircuitBreaker")
            ...
            .def("record_failure", &nerve::error::CircuitBreaker::recordFailure,
                 py::arg("operation_name"), py::arg("error_code"),
            ...
            .def("reset_stats", &nerve::error::CircuitBreaker::resetStats,
                 "Reset all statistics");

        py::class_<nerve::error::RetryBackoffManager::RetryConfig>(err, "RetryConfig")
            .def(py::init<>())
            .def_readwrite("max_retries", &nerve::error::RetryBackoffManager::RetryConfig::max_retries)
            .def_readwrite("backoff_ms", &nerve::error::RetryBackoffManager::RetryConfig::backoff_ms)
            .def_readwrite("enable_exponential_backoff", &nerve::error::RetryBackoffManager::RetryConfig::enable_exponential_backoff)
            .def_readwrite("enable_jitter", &nerve::error::RetryBackoffManager::RetryConfig::enable_jitter)
            .def_readwrite("jitter_factor", &nerve::error::RetryBackoffManager::RetryConfig::jitter_factor)
            .def_readwrite("transient_errors", &nerve::error::RetryBackoffManager::RetryConfig::transient_errors);

        py::class_<nerve::error::RetryBackoffManager::RetryStats>(err, "RetryStats")
            .def(py::init<>())
            .def_readwrite("total_retries", &nerve::error::RetryBackoffManager::RetryStats::total_retries)
            .def_readwrite("successful_retries", &nerve::error::RetryBackoffManager::RetryStats::successful_retries)
            .def_readwrite("failed_retries", &nerve::error::RetryBackoffManager::RetryStats::failed_retries)
            .def_readwrite("error_counts", &nerve::error::RetryBackoffManager::RetryStats::error_counts)
            .def_readwrite("operation_retry_counts", &nerve::error::RetryBackoffManager::RetryStats::operation_retry_counts)
            .def_readwrite("average_backoff_ms", &nerve::error::RetryBackoffManager::RetryStats::average_backoff_ms);

        py::class_<nerve::error::RetryBackoffManager>(err, "RetryBackoffManager")
            .def(py::init<const nerve::error::RetryBackoffManager::RetryConfig &>(), py::arg("config"))
            ...
            .def("is_permanent_error", &nerve::error::RetryBackoffManager::isPermanentError,
                 py::arg("error_code"),
                 "Check if an error code is considered permanent")
            .def("get_stats", &nerve::error::RetryBackoffManager::getStats,
                 "Get retry statistics")
            .def("reset_stats", &nerve::error::RetryBackoffManager::resetStats,
                 "Reset all statistics");

        py::class_<nerve::error::ErrorObservability::ObservabilityConfig>(err, "ObservabilityConfig")
            .def(py::init<>())
            .def_readwrite("enable_structured_logging", &nerve::error::ErrorObservability::ObservabilityConfig::enable_structured_logging)
            .def_readwrite("enable_metric_increment", &nerve::error::ErrorObservability::ObservabilityConfig::enable_metric_increment)
            .def_readwrite("log_format", &nerve::error::ErrorObservability::ObservabilityConfig::log_format)
            .def_readwrite("metric_prefix", &nerve::error::ErrorObservability::ObservabilityConfig::metric_prefix)
            .def_readwrite("enable_performance_correlation", &nerve::error::ErrorObservability::ObservabilityConfig::enable_performance_correlation);

        py::class_<nerve::error::ErrorObservability::ObservabilityStats>(err, "ObservabilityStats")
            .def(py::init<>())
            .def_readwrite("total_error_events", &nerve::error::ErrorObservability::ObservabilityStats::total_error_events)
            .def_readwrite("error_code_counts", &nerve::error::ErrorObservability::ObservabilityStats::error_code_counts)
            .def_readwrite("operation_error_counts", &nerve::error::ErrorObservability::ObservabilityStats::operation_error_counts)
            .def_readwrite("duration_histograms", &nerve::error::ErrorObservability::ObservabilityStats::duration_histograms)
            .def_readwrite("performance_correlations", &nerve::error::ErrorObservability::ObservabilityStats::performance_correlations);

        py::class_<nerve::error::ErrorObservability>(err, "ErrorObservability")
            .def(py::init<const nerve::error::ErrorObservability::ObservabilityConfig &>(), py::arg("config"))
            .def("log_error_event",
                 py::overload_cast<const nerve::error::ErrorEvent &>(&nerve::error::ErrorObservability::logErrorEvent),
                 py::arg("event"),
                 "Log an error event")
            .def("log_error_event_simple",
                 ...
                 "Log an error event from components")
            .def("increment_metric", &nerve::error::ErrorObservability::incrementMetric,
                 py::arg("metric_name"), py::arg("labels") = std::unordered_map<std::string, std::string>(),
            ...
            .def("correlate_performance_with_errors", &nerve::error::ErrorObservability::correlatePerformanceWithErrors,
            ...
            .def("export_error_report", &nerve::error::ErrorObservability::exportErrorReport,
                 py::arg("time_range") = "1h",
                 "Export an error report as a JSON string")
        ...
        py::class_<nerve::error::ErrorHandlingManager::ErrorHandlingStats>(err, "ErrorHandlingStats")
            .def(py::init<>())
            .def_readwrite("circuit_breaker_stats", &nerve::error::ErrorHandlingManager::ErrorHandlingStats::circuit_breaker_stats)
            .def_readwrite("retry_stats", &nerve::error::ErrorHandlingManager::ErrorHandlingStats::retry_stats)
            .def_readwrite("observability_stats", &nerve::error::ErrorHandlingManager::ErrorHandlingStats::observability_stats);
        ...
        py::class_<nerve::error::ErrorHandlingManager>(err, "ErrorHandlingManager")
            ...
            .def("set_circuit_breaker_config", &nerve::error::ErrorHandlingManager::setCircuitBreakerConfig,
                 py::arg("config"),
                 "Set the circuit breaker configuration")
            .def("set_retry_config", &nerve::error::ErrorHandlingManager::setRetryConfig,
                 py::arg("config"),
                 "Set the retry configuration")
            .def("set_observability_config", &nerve::error::ErrorHandlingManager::setObservabilityConfig,
                 py::arg("config"),
            ...
            .def("log_error", &nerve::error::ErrorHandlingManager::logError,
                 py::arg("operation_name"), py::arg("error_code"), py::arg("contract"),
                 py::arg("error_message") = "",
                 "Log an error through the observability system")
    ...
    {
        auto mem = m.def_submodule("memory",
                                    "Low-level memory management: pools, allocators, tracking");
        ...
        py::class_<nerve::memory::GlobalPagePool, std::unique_ptr<nerve::memory::GlobalPagePool, py::nodelete>>(mem, "GlobalPagePool")
            .def_static("instance", &nerve::memory::GlobalPagePool::instance,
                        py::return_value_policy::reference,
                        "Get the global page pool singleton")
            .def("allocate_page", &nerve::memory::GlobalPagePool::allocatePage,
                 "Allocate a huge page from the OS")
            .def("deallocate_page", &nerve::memory::GlobalPagePool::deallocatePage,
                 py::arg("page"),
        ...
        py::class_<nerve::memory::RawArrayPool>(mem, "RawArrayPool")
            .def(py::init<nerve::Size, bool>(),
                 py::arg("initial_bytes") = 64 * 1024 * 1024,
            ...
            .def("deallocate", &nerve::memory::RawArrayPool::deallocate,
                 py::arg("ptr"), py::arg("bytes"),
                 "Deallocate memory back to the pool")
            .def_property_readonly("total_allocated", &nerve::memory::RawArrayPool::totalAllocated,
                                   "Total bytes allocated")
            .def_property_readonly("peak_utilization", &nerve::memory::RawArrayPool::peakUtilization,
                                   "Peak bytes used")
        ...
        py::class_<nerve::memory::NumaAwareAllocator>(mem, "NumaAwareAllocator")
            ...
            .def("allocate", &nerve::memory::NumaAwareAllocator::allocate,
                 py::arg("bytes"), py::arg("alignment") = 64,
                 "Allocate aligned memory, preferring the configured NUMA node")
            .def("deallocate", &nerve::memory::NumaAwareAllocator::deallocate,
                 py::arg("ptr"), py::arg("bytes"),
                 "Deallocate memory allocated by this allocator")
            .def_property("preferred_node",
                          &nerve::memory::NumaAwareAllocator::getPreferredNode,
        ...
        py::class_<nerve::memory::SizeClassAllocator>(mem, "SizeClassAllocator")
            ...
            .def("deallocate", &nerve::memory::SizeClassAllocator::deallocate,
                 py::arg("ptr"), py::arg("bytes"),
                 "Deallocate memory back to its size class pool")
        ...
        mem.def("get_slab_allocator_diagnostic_count", &nerve::memory::getSlabAllocatorDiagnosticCount,
    ...
    // spectral/laplacian -- spectral Laplacian and Dirac operators
    {
        ...
        py::class_<nerve::spectral::LaplacianConfig>(spec, "LaplacianConfig")
            ...
            .def_readwrite("prefer_tiled_kernels", &nerve::spectral::LaplacianConfig::prefer_tiled_kernels)
            .def_readwrite("max_gpu_memory_mb", &nerve::spectral::LaplacianConfig::max_gpu_memory_mb);
        ...
        py::class_<nerve::spectral::SpectralConfig>(spec, "SpectralConfig")
            ...
            .def_readwrite("convergence_tolerance", &nerve::spectral::SpectralConfig::convergence_tolerance)
        ...
        py::class_<nerve::spectral::Laplacian>(spec, "Laplacian")
            ...
            .def("get_up_laplacian", &nerve::spectral::Laplacian::getUpLaplacian, py::arg("dimension"),
                 "Return the up Laplacian for a given dimension")
            .def("get_down_laplacian", &nerve::spectral::Laplacian::getDownLaplacian, py::arg("dimension"),
                 "Return the down Laplacian for a given dimension")
            .def("get_hodge_laplacian", &nerve::spectral::Laplacian::getHodgeLaplacian, py::arg("dimension"),
                 "Return the Hodge Laplacian for a given dimension")
            .def("eigenvalues", &nerve::spectral::Laplacian::eigenvalues,
                 py::arg("dimension"), py::arg("k") = 0,
                 "Compute eigenvalues for a given dimension")
            .def("eigenvectors", &nerve::spectral::Laplacian::eigenvectors,
                 py::arg("dimension"), py::arg("k") = 0,
                 "Compute eigenvectors for a given dimension")
            ...
            .def("heat_kernel", &nerve::spectral::Laplacian::heatKernel,
                 py::arg("dimension"), py::arg("t"),
                 "Compute the heat kernel for a given dimension and time")
            .def("heat_flow", &nerve::spectral::Laplacian::heatFlow,
                 py::arg("initial"), py::arg("dimension"), py::arg("t"),
                 "Compute the heat flow of an initial state")
            .def("compute_spectral_gap", &nerve::spectral::Laplacian::computeSpectralGap,
                 py::arg("dimension"),
                 "Compute the spectral gap for a given dimension")
        ...
        py::class_<nerve::spectral::DiracOperator>(spec, "DiracOperator")
            ...
            .def("compute_atiyah_singer_index", &nerve::spectral::DiracOperator::computeAtiyahSingerIndex,
                 "Compute the Atiyah-Singer index")
            .def("compute_analytical_index", &nerve::spectral::DiracOperator::computeAnalyticalIndex,
                 "Compute the analytical index")
            .def("compute_topological_index", &nerve::spectral::DiracOperator::computeTopologicalIndex,
                 "Compute the topological index");
    }

    // sheaf/gpu_sheaf -- sheaf theory operations
    {
        auto sheaf = m.def_submodule("sheaf",
                                      "Sheaf theory: engine, hardware detection, parallel/morphism ops");
        ...
        py::class_<nerve::sheaf::Point>(sheaf, "Point")
            ...
            .def("__repr__", [](const nerve::sheaf::Point &p) {
                return "Point(" + std::to_string(p.x) + ", " + std::to_string(p.y) + ", " + std::to_string(p.z) + ")";
            });

        // SheafEngine
        py::class_<nerve::sheaf::SheafEngine>(sheaf, "SheafEngine")
            .def(py::init<const nerve::sheaf::SheafConfig &>(), py::arg("config") = nerve::sheaf::SheafConfig(),
                 "Create a SheafEngine with the given configuration")
            .def("build_sheaf", &nerve::sheaf::SheafEngine::buildSheaf,
                 py::arg("stalk_positions"), py::arg("stalk_dimensions"),
                 "Build a sheaf from stalk positions and dimensions")
            .def("compute_cohomology", &nerve::sheaf::SheafEngine::computeCohomology,
                 py::arg("cocycle"),
                 "Compute sheaf cohomology from a cocycle")
            .def("apply_morphism", [](nerve::sheaf::SheafEngine &self,
                                       int from_stalk, int to_stalk,
        ...
        // Parallel sub-module
        {
            auto para = sheaf.def_submodule("parallel",
                                             "Parallel sheaf construction and SIMD stalk ops");
            ...
            py::class_<nerve::sheaf::parallel::ParallelSheafBuilder::SheafConfig>(para, "ParallelSheafConfig")
                .def(py::init<>())
                .def_readwrite("num_stalks", &nerve::sheaf::parallel::ParallelSheafBuilder::SheafConfig::num_stalks)
                .def_readwrite("stalk_dimension", &nerve::sheaf::parallel::ParallelSheafBuilder::SheafConfig::stalk_dimension)
                .def_readwrite("use_simd", &nerve::sheaf::parallel::ParallelSheafBuilder::SheafConfig::use_simd)
                .def_readwrite("num_threads", &nerve::sheaf::parallel::ParallelSheafBuilder::SheafConfig::num_threads);

            py::class_<nerve::sheaf::parallel::ParallelSheafBuilder>(para, "ParallelSheafBuilder")
                .def(py::init<const nerve::sheaf::parallel::ParallelSheafBuilder::SheafConfig &>(), py::arg("config"),
                     "Create a parallel sheaf builder")
            ...
            py::class_<nerve::sheaf::parallel::SIMDStalkOperations>(para, "SIMDStalkOperations")
                ...
                .def_static("dot_product", &nerve::sheaf::parallel::SIMDStalkOperations::dotProduct,
                            py::arg("a"), py::arg("b"),
                            "Compute dot product of two stalks")
                .def_static("normalize_stalk", &nerve::sheaf::parallel::SIMDStalkOperations::normalizeStalk,
                            py::arg("stalk"),
                            "Normalize a stalk to unit length");
            ...
            py::class_<nerve::sheaf::parallel::StalkSpatialHash>(para, "StalkSpatialHash")
                ...
                .def("get_nearby_stalks", &nerve::sheaf::parallel::StalkSpatialHash::getNearbyStalks,
                     py::arg("position"),
                     "Get stalk IDs near a position");

            py::class_<nerve::sheaf::parallel::SheafParallelBenchmark>(para, "SheafParallelBenchmark")
                .def(py::init<>())
                .def_readwrite("sequential_time_ms", &nerve::sheaf::parallel::SheafParallelBenchmark::sequential_time_ms)
                .def_readwrite("parallel_time_ms", &nerve::sheaf::parallel::SheafParallelBenchmark::parallel_time_ms)
                .def_readwrite("simd_time_ms", &nerve::sheaf::parallel::SheafParallelBenchmark::simd_time_ms)
                .def_readwrite("speedup_parallel", &nerve::sheaf::parallel::SheafParallelBenchmark::speedup_parallel)
                .def_readwrite("speedup_simd", &nerve::sheaf::parallel::SheafParallelBenchmark::speedup_simd)
                .def_readwrite("num_stalks", &nerve::sheaf::parallel::SheafParallelBenchmark::num_stalks)
                .def_readwrite("stalk_dim", &nerve::sheaf::parallel::SheafParallelBenchmark::stalk_dim)
                .def_readwrite("num_threads", &nerve::sheaf::parallel::SheafParallelBenchmark::num_threads);
        ...
        // Morphism sub-module
        {
            auto morph = sheaf.def_submodule("morphism",
                                              "Morphism operations and optimization");
            ...
            py::class_<nerve::sheaf::morphism::SparseMorphism>(morph, "SparseMorphism")
                ...
                .def("apply", [](const nerve::sheaf::morphism::SparseMorphism &self,
                                  const std::vector<float> &input) {
                    std::vector<float> output;
                    self.apply(input, output);
                    return output;
                }, py::arg("input"), "Apply the morphism to an input vector")
                .def("apply_simd", [](const nerve::sheaf::morphism::SparseMorphism &self,
                                       const std::vector<float> &input) {
            ...
            py::class_<nerve::sheaf::morphism::MorphismMemoryPool>(morph, "MorphismMemoryPool")
                ...
                .def("allocate_morphism", &nerve::sheaf::morphism::MorphismMemoryPool::allocateMorphism,
                     py::arg("nnz"),
                     "Allocate memory for a morphism with the given number of non-zeros")
                .def("reset", &nerve::sheaf::morphism::MorphismMemoryPool::reset,
                     "Reset the pool, freeing all allocations");

            py::class_<nerve::sheaf::morphism::BatchedMorphismComputer>(morph, "BatchedMorphismComputer")
                ...
                .def("compute_batch", [](nerve::sheaf::morphism::BatchedMorphismComputer &self,
            ...
            py::class_<nerve::sheaf::morphism::MorphismCompositionOptimizer>(morph, "MorphismCompositionOptimizer")
                .def(py::init<>(), "Create a morphism composition optimizer")
                .def("register_chain", &nerve::sheaf::morphism::MorphismCompositionOptimizer::registerChain,
                     py::arg("stalk_chain"),
                     "Register a stalk chain for composition optimization")
                .def("add_morphism", &nerve::sheaf::morphism::MorphismCompositionOptimizer::addMorphism,
                     py::arg("from"), py::arg("to"), py::arg("morphism"),
                     "Add a morphism to the optimizer")
                .def("get_composed", &nerve::sheaf::morphism::MorphismCompositionOptimizer::getComposed,
    ...
    // compression -- header-only compression primitives
    {
        auto comp = m.def_submodule("compression",
                                     "Compression: PCA, quantize, config");

        py::class_<nerve::compression::CompressionConfig>(comp, "CompressionConfig")
            .def(py::init<>())
            .def_readwrite("compression_method", &nerve::compression::CompressionConfig::compression_method)
            .def_readwrite("pca_components", &nerve::compression::CompressionConfig::pca_components)
            .def_readwrite("pca_variance_retained", &nerve::compression::CompressionConfig::pca_variance_retained)
            .def_readwrite("enable_gpu_acceleration", &nerve::compression::CompressionConfig::enable_gpu_acceleration)
            .def_readwrite("target_compression_ratio", &nerve::compression::CompressionConfig::target_compression_ratio)
            .def_readwrite("quality_threshold", &nerve::compression::CompressionConfig::quality_threshold);
        ...
        py::class_<nerve::compression::CompressionResult>(comp, "CompressionResult")
            ...
            .def_readwrite("compressed_size", &nerve::compression::CompressionResult::compressed_size)
            .def_readwrite("compression_ratio", &nerve::compression::CompressionResult::compression_ratio)
            .def_readwrite("quality_score", &nerve::compression::CompressionResult::quality_score)
            .def_readwrite("compression_time_ms", &nerve::compression::CompressionResult::compression_time_ms)
            .def_readwrite("compressed_data", &nerve::compression::CompressionResult::compressed_data)
        ...
        py::class_<nerve::compression::PCACompression>(comp, "PCACompression")
            .def(py::init<const nerve::compression::CompressionConfig &>(), py::arg("config") = nerve::compression::CompressionConfig(),
    ...
    {
        auto algo = m.def_submodule("algorithms",
                                     "Distance metrics, KNN, persistence vectorization");

        // C extern wrapper: pairwise_distances_f32
        algo.def("pairwise_distances_f32",
                 [](py::array_t<float, py::array::c_style | py::array::forcecast> points) {
                     ...
                     py::array_t<float> result({static_cast<py::ssize_t>(n), static_cast<py::ssize_t>(n)});
                     std::memcpy(result.mutable_data(), output.data(), n * n * sizeof(float));
                     return result;
                 },
                 py::arg("points"),
                 "Compute pairwise Euclidean distance matrix (float32)");

        // C extern wrapper: pairwise_distances_f64
        algo.def("pairwise_distances_f64",
                 [](py::array_t<double, py::array::c_style | py::array::forcecast> points) {
                     ...
                     py::array_t<double> result({static_cast<py::ssize_t>(n), static_cast<py::ssize_t>(n)});
                     std::memcpy(result.mutable_data(), output.data(), n * n * sizeof(double));
                     return result;
                 },
                 py::arg("points"),
                 "Compute pairwise Euclidean distance matrix (float64)");
        ...
        algo.def("knn_f32",
                 [](py::array_t<float, py::array::c_style | py::array::forcecast> points, size_t k) {
                     ...
                     nerve_status_t status = nerve_knn_f32_status(
                         static_cast<const float *>(info.ptr), n, dim, k,
                         distances.data(), indices.data());
                     if (status != NERVE_STATUS_SUCCESS)
                         throw std::runtime_error("knn_f32 failed");
                     py::array_t<float> dist_arr({static_cast<py::ssize_t>(n), static_cast<py::ssize_t>(k)});
                     py::array_t<size_t> idx_arr({static_cast<py::ssize_t>(n), static_cast<py::ssize_t>(k)});
        ...
        algo.def("knn_f64",
                 [](py::array_t<double, py::array::c_style | py::array::forcecast> points, size_t k) {
                     ...
                     std::vector<size_t> indices(n * k, 0);
                     nerve_status_t status = nerve_knn_f64_status(
                         static_cast<const double *>(info.ptr), n, dim, k,
                         distances.data(), indices.data());
                     if (status != NERVE_STATUS_SUCCESS)
                         throw std::runtime_error("knn_f64 failed");
                     py::array_t<double> dist_arr({static_cast<py::ssize_t>(n), static_cast<py::ssize_t>(k)});
                     py::array_t<size_t> idx_arr({static_cast<py::ssize_t>(n), static_cast<py::ssize_t>(k)});
        ...
        py::class_<nerve::algorithms::PersistenceLandscape>(algo, "PersistenceLandscape")
            .def(py::init<>())
            .def_readwrite("landscape_levels", &nerve::algorithms::PersistenceLandscape::landscape_levels)
            ...
            .def("__repr__", [](const nerve::algorithms::PersistenceLandscape &l) {
                return "PersistenceLandscape(levels=" + std::to_string(l.num_levels)
                     + ", x=[" + std::to_string(l.x_min) + ", " + std::to_string(l.x_max) + "])";
            });
        ...
        algo.def("compute_landscape_f32",
        ...
        algo.def("compute_landscape_f64",
                 [](py::array_t<double, py::array::c_style | py::array::forcecast> diagram,
                    int num_levels, double resolution) {
                     ...
                     return nerve::algorithms::compute_landscape<double>(span, n, num_levels, resolution);
                 },
                 py::arg("diagram"), py::arg("num_levels") = 5, py::arg("resolution") = 0.01,
                 "Compute persistence landscape from a float64 diagram (Nx2 array)");

        algo.def("compute_persistence_image_f32",
                 [](py::array_t<float, py::array::c_style | py::array::forcecast> diagram,
                    int resolution, double sigma) {
                     ...
                     size_t n = static_cast<size_t>(info.shape[0]);
                     std::span<const float> span(static_cast<const float *>(info.ptr), n * 2);
                     return nerve::algorithms::compute_persistence_image<float>(span, n, resolution, sigma);
                 },
                 py::arg("diagram"), py::arg("resolution") = 64, py::arg("sigma") = 0.1,
                 "Compute persistence image from a float32 diagram (Nx2 array)");

        algo.def("compute_persistence_image_f64",
                 [](py::array_t<double, py::array::c_style | py::array::forcecast> diagram,
                    int resolution, double sigma) {
                     py::buffer_info info = diagram.request();
                     if (info.ndim != 2 || info.shape[1] != 2)
                     ...
                     size_t n = static_cast<size_t>(info.shape[0]);
                     std::span<const double> span(static_cast<const double *>(info.ptr), n * 2);
                     return nerve::algorithms::compute_persistence_image<double>(span, n, resolution, sigma);
                 },
                 py::arg("diagram"), py::arg("resolution") = 64, py::arg("sigma") = 0.1,
                 "Compute persistence image from a float64 diagram (Nx2 array)");

        algo.def("compute_betti_curve_f32",
                 [](py::array_t<float, py::array::c_style | py::array::forcecast> diagram,
                    int max_dim) {
                     py::buffer_info info = diagram.request();
                     if (info.ndim != 2 || info.shape[1] != 2)
        ...
        algo.def("compute_betti_curve_f64",
                 [](py::array_t<double, py::array::c_style | py::array::forcecast> diagram,
                    int max_dim) {
                     py::buffer_info info = diagram.request();
                     if (info.ndim != 2 || info.shape[1] != 2)
    ...
    {
        auto ser = m.def_submodule("serialization",
                                    "Schema versioning, serialization formats, PH5/PH6 artifact support");
        ...
        py::class_<nerve::serialization::SchemaVersion>(ser, "SchemaVersion")
            ...
            .def("__eq__", &nerve::serialization::SchemaVersion::operator==,
                 py::arg("other"))
            .def("__lt__", &nerve::serialization::SchemaVersion::operator<,
                 py::arg("other"))
            .def("__le__", &nerve::serialization::SchemaVersion::operator<=,
                 py::arg("other"))
            .def("__ge__", &nerve::serialization::SchemaVersion::operator>=,
                 py::arg("other"))
        ...
        py::class_<nerve::serialization::SchemaMetadata>(ser, "SchemaMetadata")
            ...
            .def_readwrite("min_compatible_version", &nerve::serialization::SchemaMetadata::minCompatibleVersion)
            .def_readwrite("max_compatible_version", &nerve::serialization::SchemaMetadata::maxCompatibleVersion)
            ...
            .def("is_version_compatible", &nerve::serialization::SchemaMetadata::isVersionCompatible,
                 py::arg("check_version"),
                 "Check if a version is compatible with this schema")
        ...
        py::class_<nerve::serialization::SerializationContext>(ser, "SerializationContext")
            .def(py::init<nerve::serialization::SerializationFormat, nerve::serialization::SchemaVersion>(),
            ...
            .def_readwrite("schema_version", &nerve::serialization::SerializationContext::schemaVersion)
            .def_readwrite("options", &nerve::serialization::SerializationContext::options);

        // SerializationErrorCode enum
        py::enum_<nerve::serialization::errors::SerializationErrorCode>(ser, "SerializationErrorCode")
            .value("SUCCESS", nerve::serialization::errors::SerializationErrorCode::SUCCESS)
            .value("INCOMPATIBLE_SCHEMA_VERSION", nerve::serialization::errors::SerializationErrorCode::INCOMPATIBLE_SCHEMA_VERSION)
            .value("UNSUPPORTED_SCHEMA_VERSION", nerve::serialization::errors::SerializationErrorCode::UNSUPPORTED_SCHEMA_VERSION)
            .value("SCHEMA_VERSION_NEGOTIATION_FAILED", nerve::serialization::errors::SerializationErrorCode::SCHEMA_VERSION_NEGOTIATION_FAILED)
            .value("SCHEMA_NOT_FOUND", nerve::serialization::errors::SerializationErrorCode::SCHEMA_NOT_FOUND)
            .value("UNSUPPORTED_SERIALIZATION_FORMAT", nerve::serialization::errors::SerializationErrorCode::UNSUPPORTED_SERIALIZATION_FORMAT)
            .value("SERIALIZATION_FORMAT_MISMATCH", nerve::serialization::errors::SerializationErrorCode::SERIALIZATION_FORMAT_MISMATCH)
            .value("INVALID_SERIALIZATION_DATA", nerve::serialization::errors::SerializationErrorCode::INVALID_SERIALIZATION_DATA)
            .value("DESERIALIZATION_FAILED", nerve::serialization::errors::SerializationErrorCode::DESERIALIZATION_FAILED)
            .value("METADATA_MISSING", nerve::serialization::errors::SerializationErrorCode::METADATA_MISSING)
            .export_values();
        ...
        py::class_<nerve::serialization::VersionNegotiationResult>(ser, "VersionNegotiationResult")
            ...
            .def_readwrite("negotiated_version", &nerve::serialization::VersionNegotiationResult::negotiated_version)
            .def_readwrite("error_message", &nerve::serialization::VersionNegotiationResult::error_message)
            .def_readwrite("requires_conversion", &nerve::serialization::VersionNegotiationResult::requiresConversion)
            .def_readwrite("conversion_strategy", &nerve::serialization::VersionNegotiationResult::conversion_strategy)
            .def_static("success_result", &nerve::serialization::VersionNegotiationResult::successResult,
                        py::arg("version"), py::arg("needs_conversion") = false, py::arg("strategy") = "",
                        "Create a success result")
            .def_static("error_result", &nerve::serialization::VersionNegotiationResult::errorResult,
                        py::arg("error"),
        ...
        py::class_<nerve::serialization::VersionNegotiator>(ser, "VersionNegotiator")
            ...
            .def("negotiate_version",
                 ...
                 py::arg("schema_name"), py::arg("requested_version"), py::arg("supported_versions"),
                 "Negotiate a version against supported versions")
            .def("negotiate_version_simple",
                 py::overload_cast<const std::string &, const nerve::serialization::SchemaVersion &>(
                     &nerve::serialization::VersionNegotiator::negotiateVersion),
            ...
            .def("get_registered_schemas", &nerve::serialization::VersionNegotiator::getRegisteredSchemas,
                 "Get names of all registered schemas")
            .def("get_supported_versions", &nerve::serialization::VersionNegotiator::getSupportedVersions,
                 py::arg("schema_name"),
                 "Get supported versions for a schema")
            .def("is_version_supported", &nerve::serialization::VersionNegotiator::isVersionSupported,
                 py::arg("schema_name"), py::arg("version"),
                 "Check if a version is supported")
            .def("are_versions_compatible", &nerve::serialization::VersionNegotiator::areVersionsCompatible,
        ...
        py::class_<nerve::serialization::FlatBuffersSerializer>(ser, "FlatBuffersSerializer")
            .def(py::init<>())
            .def("serialize", [](nerve::serialization::FlatBuffersSerializer &self,
                                  py::bytes data, const nerve::serialization::SerializationContext &ctx) {
                std::string raw = data;
                auto result = self.serialize(raw.data(), raw.size(), ctx);
                if (result.isError())
                    throw std::runtime_error("FlatBuffers serialization failed: " + result.error().message);
                auto &vec = result.value();
                return py::bytes(reinterpret_cast<const char *>(vec.data()), vec.size());
            }, py::arg("data"), py::arg("context"),
              "Serialize raw bytes using FlatBuffers")
            .def("deserialize", [](nerve::serialization::FlatBuffersSerializer &self,
                                    py::bytes data, const nerve::serialization::SerializationContext &ctx) {
                std::string raw = data;
                std::vector<uint8_t> buf(raw.begin(), raw.end());
                auto result = self.deserialize(buf, ctx);
                if (result.isError())
                    throw std::runtime_error("FlatBuffers deserialization failed: " + result.error().message);
                auto &vec = result.value();
                return py::bytes(reinterpret_cast<const char *>(vec.data()), vec.size());
            }, py::arg("data"), py::arg("context"),
              "Deserialize to raw bytes using FlatBuffers")
        ...
        py::class_<nerve::serialization::ArrowSerializer>(ser, "ArrowSerializer")
            .def(py::init<>())
            .def("serialize", [](nerve::serialization::ArrowSerializer &self,
                                  py::bytes data, const nerve::serialization::SerializationContext &ctx) {
                std::string raw = data;
                auto result = self.serialize(raw.data(), raw.size(), ctx);
                if (result.isError())
                    throw std::runtime_error("Arrow serialization failed: " + result.error().message);
                auto &vec = result.value();
                return py::bytes(reinterpret_cast<const char *>(vec.data()), vec.size());
            }, py::arg("data"), py::arg("context"),
              "Serialize raw bytes using Apache Arrow")
            .def("deserialize", [](nerve::serialization::ArrowSerializer &self,
                                    py::bytes data, const nerve::serialization::SerializationContext &ctx) {
                std::string raw = data;
                std::vector<uint8_t> buf(raw.begin(), raw.end());
                auto result = self.deserialize(buf, ctx);
                if (result.isError())
                    throw std::runtime_error("Arrow deserialization failed: " + result.error().message);
                auto &vec = result.value();
                return py::bytes(reinterpret_cast<const char *>(vec.data()), vec.size());
            }, py::arg("data"), py::arg("context"),
              "Deserialize to raw bytes using Apache Arrow")
        ...
        py::class_<nerve::serialization::SerializationManager>(ser, "SerializationManager")
            ...
            .def("register_serializer", [](nerve::serialization::SerializationManager &self,
                                             std::unique_ptr<nerve::serialization::Serializer> serializer) {
                self.registerSerializer(std::move(serializer));
            }, py::arg("serializer"),
              "Register a serializer")
            .def("unregister_serializer", &nerve::serialization::SerializationManager::unregisterSerializer,
                 py::arg("format"),
                 "Unregister a serializer by format")
            .def("serialize", [](nerve::serialization::SerializationManager &self,
                                  const std::string &schema_name, py::bytes data,
                                  const nerve::serialization::SerializationContext &context) {
                std::string raw = data;
            ...
            .def("deserialize", [](nerve::serialization::SerializationManager &self,
                                    const std::string &schema_name, py::bytes data,
                                    const nerve::serialization::SerializationContext &context) {
                std::string raw = data;
                std::vector<uint8_t> buf(raw.begin(), raw.end());
                ...
                if (result.isError())
                    throw std::runtime_error("Deserialization failed: " + result.error().message);
                auto &vec = result.value();
                return py::bytes(reinterpret_cast<const char *>(vec.data()), vec.size());
            }, py::arg("schema_name"), py::arg("data"), py::arg("context"),
              "Deserialize data through the manager")
            .def("load_from_file", [](nerve::serialization::SerializationManager &self,
                                       const std::string &path, const std::string &schema_name,
                                       nerve::serialization::SerializationFormat format) {
                auto result = self.loadFromFile(path, schema_name, format);
                if (result.isError())
                    throw std::runtime_error("Load from file failed: " + result.error().message);
                auto &vec = result.value();
                return py::bytes(reinterpret_cast<const char *>(vec.data()), vec.size());
            }, py::arg("path"), py::arg("schema_name"), py::arg("format"),
              "Load serialized data from a file")
            .def("save_to_file", [](nerve::serialization::SerializationManager &self,
                                     const std::string &path, const std::string &schema_name,
                                     py::bytes data, nerve::serialization::SerializationFormat format) {
                std::string raw = data;
                auto result = self.saveToFile(path, schema_name, raw.data(), raw.size(), format);
                if (result.isError())
            ...
            .def("get_schema_metadata", &nerve::serialization::SerializationManager::getSchemaMetadata,
                 py::arg("schema_name"),
                 "Get metadata for a schema")
            .def("get_supported_formats", &nerve::serialization::SerializationManager::getSupportedFormats,
                 "Get list of supported serialization formats")
            .def("is_format_supported", &nerve::serialization::SerializationManager::isFormatSupported,
                 py::arg("format"),
                 "Check if a format is supported");

        // Free utility functions
        ser.def("serialization_format_to_string", &nerve::serialization::serialization_format_to_string,
                py::arg("format"),
                "Convert a SerializationFormat to its string representation");
        ser.def("string_to_serialization_format", &nerve::serialization::stringToSerializationFormat,
                py::arg("format_str"),
                "Parse a string into a SerializationFormat");
        ser.def("is_schema_version_valid", &nerve::serialization::isSchemaVersionValid,
                py::arg("version"),
                "Check if a SchemaVersion is valid");
        ser.def("is_version_compatible", &nerve::serialization::isVersionCompatible,
                py::arg("current"), py::arg("target"),
                "Check if two versions are compatible");
        ser.def("test_round_trip_compatibility", [](const std::string &schema_name,
                                                      py::bytes data,
        ...
        ser.def("migrate_schema", [](py::bytes data,
                                       const nerve::serialization::SchemaVersion &from_version,
                                       const nerve::serialization::SchemaVersion &to_version,
                                       const std::string &schema_name) {
            std::string raw = data;
            std::vector<uint8_t> buf(raw.begin(), raw.end());
            auto result = nerve::serialization::migrateSchema(buf, from_version, to_version, schema_name);
            if (result.isError())
        ...
        py::class_<nerve::serialization::PH5PH6ArtifactMetadata>(ser, "PH5PH6ArtifactMetadata")
            .def(py::init<>())
            .def_readwrite("schema_version", &nerve::serialization::PH5PH6ArtifactMetadata::schema_version)
            .def_readwrite("artifact_type", &nerve::serialization::PH5PH6ArtifactMetadata::artifact_type)
            .def_readwrite("algorithm_variant", &nerve::serialization::PH5PH6ArtifactMetadata::algorithm_variant)
            .def_readwrite("has_highdim_extension", &nerve::serialization::PH5PH6ArtifactMetadata::has_highdim_extension)
            .def_readwrite("max_supported_dimension", &nerve::serialization::PH5PH6ArtifactMetadata::max_supported_dimension)
            .def_readwrite("extension_fields", &nerve::serialization::PH5PH6ArtifactMetadata::extension_fields)
            .def_readwrite("min_compatible_version", &nerve::serialization::PH5PH6ArtifactMetadata::min_compatible_version)
            .def_readwrite("deprecated_fields", &nerve::serialization::PH5PH6ArtifactMetadata::deprecated_fields)
            .def_readwrite("new_fields", &nerve::serialization::PH5PH6ArtifactMetadata::new_fields)
            .def("serialize_metadata", &nerve::serialization::PH5PH6ArtifactMetadata::serializeMetadata,
                 "Serialize metadata to bytes")
            .def("deserialize_metadata", [](nerve::serialization::PH5PH6ArtifactMetadata &self,
                                              py::bytes data) {
                std::string raw = data;
                std::vector<uint8_t> buf(raw.begin(), raw.end());
        ...
        py::class_<nerve::serialization::PH5PH6SchemaSerializer>(ser, "PH5PH6SchemaSerializer")
            .def(py::init<>())
            .def("serialize", [](nerve::serialization::PH5PH6SchemaSerializer &self,
                                  py::bytes data, const nerve::serialization::SerializationContext &ctx) {
                std::string raw = data;
                auto result = self.serialize(raw.data(), raw.size(), ctx);
                if (result.isError())
                    throw std::runtime_error("PH5PH6 serialization failed: " + result.error().message);
                auto &vec = result.value();
                return py::bytes(reinterpret_cast<const char *>(vec.data()), vec.size());
            }, py::arg("data"), py::arg("context"),
              "Serialize data using PH5PH6 schema")
            .def("deserialize", [](nerve::serialization::PH5PH6SchemaSerializer &self,
                                    py::bytes data, const nerve::serialization::SerializationContext &ctx) {
                std::string raw = data;
                std::vector<uint8_t> buf(raw.begin(), raw.end());
                auto result = self.deserialize(buf, ctx);
                if (result.isError())
                    throw std::runtime_error("PH5PH6 deserialization failed: " + result.error().message);
                auto &vec = result.value();
                return py::bytes(reinterpret_cast<const char *>(vec.data()), vec.size());
            }, py::arg("data"), py::arg("context"),
              "Deserialize data using PH5PH6 schema")
            .def("serialize_ph5_artifact", [](nerve::serialization::PH5PH6SchemaSerializer &self,
                                               py::bytes data,
                ...
                if (result.isError())
                    throw std::runtime_error("PH5 artifact serialization failed: " + result.error().message);
                auto &vec = result.value();
                return py::bytes(reinterpret_cast<const char *>(vec.data()), vec.size());
            }, py::arg("data"), py::arg("artifact_metadata"), py::arg("context"),
              "Serialize a PH5 artifact")
            .def("serialize_ph6_artifact", [](nerve::serialization::PH5PH6SchemaSerializer &self,
                                               py::bytes data,
                                               const nerve::serialization::PH5PH6ArtifactMetadata &meta,
                                               const nerve::serialization::SerializationContext &ctx) {
                std::string raw = data;
                ...
                if (result.isError())
                    throw std::runtime_error("PH6 artifact serialization failed: " + result.error().message);
                auto &vec = result.value();
                return py::bytes(reinterpret_cast<const char *>(vec.data()), vec.size());
            }, py::arg("data"), py::arg("artifact_metadata"), py::arg("context"),
              "Serialize a PH6 artifact")
            .def("serialize_compact_summary", [](nerve::serialization::PH5PH6SchemaSerializer &self,
                                                  const nerve::summary::CompactSummary &summary,
                                                  const nerve::serialization::PH5PH6ArtifactMetadata &meta,
                                                  const nerve::serialization::SerializationContext &ctx) {
                auto result = self.serializeCompactSummary(summary, meta, ctx);
                if (result.isError())
                    throw std::runtime_error("CompactSummary serialization failed: " + result.error().message);
                auto &vec = result.value();
                return py::bytes(reinterpret_cast<const char *>(vec.data()), vec.size());
            }, py::arg("summary"), py::arg("artifact_metadata"), py::arg("context"),
              "Serialize a CompactSummary as a PH5/PH6 artifact")
            .def("deserialize_compact_summary", [](nerve::serialization::PH5PH6SchemaSerializer &self,
                                                    py::bytes data,
                                                    const nerve::serialization::SerializationContext &ctx) {
                std::string raw = data;
                std::vector<uint8_t> buf(raw.begin(), raw.end());
                ...
                if (result.isError())
                    throw std::runtime_error("CompactSummary deserialization failed: " + result.error().message);
                auto &[summary, meta] = result.value();
                return py::make_tuple(summary, meta);
            }, py::arg("data"), py::arg("context"),
              "Deserialize a CompactSummary from bytes")
            .def("is_version_compatible", &nerve::serialization::PH5PH6SchemaSerializer::isVersionCompatible,
                 py::arg("version"),
                 "Check if a schema version is compatible")
            .def("get_min_compatible_version", &nerve::serialization::PH5PH6SchemaSerializer::getMinCompatibleVersion,
                 "Get the minimum compatible schema version")
            .def("get_schema_version", &nerve::serialization::PH5PH6SchemaSerializer::getSchemaVersion,
        ...
        py::class_<nerve::serialization::PH5PH6SchemaRegistry>(ser, "PH5PH6SchemaRegistry")
            .def(py::init<>())
            .def("register_artifact_type", &nerve::serialization::PH5PH6SchemaRegistry::registerArtifactType,
                 py::arg("artifact_type"), py::arg("metadata"),
                 "Register an artifact type with metadata")
            .def("unregister_artifact_type", &nerve::serialization::PH5PH6SchemaRegistry::unregisterArtifactType,
                 py::arg("artifact_type"),
            ...
            .def("get_artifact_metadata", &nerve::serialization::PH5PH6SchemaRegistry::getArtifactMetadata,
                 py::arg("artifact_type"),
                 "Get metadata for an artifact type")
            .def("get_registered_artifact_types", &nerve::serialization::PH5PH6SchemaRegistry::getRegisteredArtifactTypes,
                 "Get all registered artifact type names")
            .def("is_artifact_supported", &nerve::serialization::PH5PH6SchemaRegistry::isArtifactSupported,
            ...
            .def("create_compatible_serializer", &nerve::serialization::PH5PH6SchemaRegistry::createCompatibleSerializer,
        ...
        py::class_<nerve::serialization::PH5PH6SchemaMigrator>(ser, "PH5PH6SchemaMigrator")
            .def_static("migrate_to_extended",
                        [](py::bytes data, const nerve::serialization::SerializationContext &ctx) {
                            std::string raw = data;
                            std::vector<uint8_t> buf(raw.begin(), raw.end());
                            auto result = nerve::serialization::PH5PH6SchemaMigrator::migrateToExtended(buf, ctx);
                            if (!result.success)
                                throw std::runtime_error("Migration failed: " + result.error_message);
                            auto migrated = py::bytes(
                                reinterpret_cast<const char *>(result.migrated_data.data()),
            ...
            .def_static("migrate_with_extension",
                        [](py::bytes data,
            ...
            .def_static("validate_data",
                        [](py::bytes data) {
                            std::string raw = data;
                            std::vector<uint8_t> buf(raw.begin(), raw.end());
                            return nerve::serialization::PH5PH6SchemaMigrator::validateData(buf);
                        }, py::arg("data"),
              "Validate PH5/PH6 data integrity")
            .def_static("validate_extended_data",
                        [](py::bytes data,
